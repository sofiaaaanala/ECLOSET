          ...
          <div className="space-y-5">
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <div className="relative">
                ...
                <div className="w-4 h-4 rounded border transition-all peer-checked:border-[#A8C5A0] peer-checked:bg-[#A8C5A0]" style={{ border: "1.5px solid #ccc" }} />
              </div>
              <span className="text-xs" style={{ color: "#9a9a8e" }}>Keep me signed in</span>
            </label>
